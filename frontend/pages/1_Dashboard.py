...
# ── KPI Cards ─────────────────────────────────────────────────────────────────
# Taux de succès = documents traités correctement (validés + need_review + rejetés par DiT)
# need_review = facture reconnue mais champs manquants → succès du pipeline DiT/OCR
